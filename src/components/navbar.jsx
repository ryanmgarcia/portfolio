  ...
  return (
    <div className='flex items-center justify-between px-10 pt-[45px]'>
        <div className='flex gap-x-[100px]'>
            <a href={"/"}>
                <img src={logo} alt="logo" className='h-[40px] w-[40px] rounded-md lg:rounded-lg xl:h-[60px] xl:w-[60px]' />
            </a>
        ...
        <div className='block lg:hidden'>
            <FontAwesomeIcon icon={faBars} className="text-2xl text-white" onClick={handleSidebar} />
        </div>
    </div>
  )
}
