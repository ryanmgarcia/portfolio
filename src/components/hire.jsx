  ...
  return (
    <div className='flex items-center justify-center bg-darker pt-10 pb-14 md:py-32'>
        <div className='text-center'>
            ...
            <button className='rounded-lg bg-accent/80 py-2 px-4 font-roboto text-xs font-semibold uppercase text-white transition-all hover:bg-accent md:px-8 md:text-[13px]'>
                Hire Me
            </button>
        </div>
    </div>
