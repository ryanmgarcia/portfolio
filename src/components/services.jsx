import { faDisplay, faGamepad, faMobileScreen } from '@fortawesome/free-solid-svg-icons';
...
const Services = () => {
  ...
  return (
    <div className='overflow-x-hidden bg-darker pt-20 pb-14 md:pt-32 md:pb-44' id="services">
        ...
        <div className='flex flex-col items-center justify-center px-14 text-center md:px-8 lg:flex-row xl:gap-x-10'>
            {serviceList.map((service, i) => (
                <div key={i} className="group relative">
                    <div className='relative z-10 rounded-md py-8 px-6 transition-all md:w-[280px] md:py-16 md:group-hover:bg-dark lg:w-[330px]'>
                        <div>
                            <div className='mb-6 text-white md:mb-9'>
                                <FontAwesomeIcon icon={service.icon} className="text-5xl md:text-6xl" />
                            </div>
                    ...
                    <div className='absolute top-8 left-0 hidden h-full w-full rounded-lg bg-accent/0 transition-all group-hover:top-[12px] group-hover:left-[12px] group-hover:bg-accent/100 md:block'></div>
                </div>
            ))}
        </div>
    </div>
