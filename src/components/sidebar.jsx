...
const Sidebar = ({show, handleSidebar}) => {
  ...
  return (
    <div className={`fixed inset-y0 z-20 flex w-[320ox] flex-col bg-dark py-[20px] pl-[40px] pr-[20px] text-white transition-all ${show ? "right-0": "right-full"}`}>
        <div className='mb-[30px] text-right'>
            <FontAwesomeIcon icon={faXmark} className="text-2xl" onClick={handleSidebar} />
        </div>
        ...
        <div className='mt-auto flex items-center gap-x-4'>
            ...
            <a href="#contact-me" className='block rounded-lg bg-accent/90 px-4 py-2 font-poppins text-[15px] font-bold'>
                Contact Me
            </a>
        </div>
    </div>
